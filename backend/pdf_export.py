...
def _header_table(styles, url: str, crawl_status: dict) -> Table:
    """Top banner with site URL + key stats."""
    ...
    data = [[
        Paragraph(f"<b>CrawlIQ Audit Report</b>", styles["title"]),
...
def generate_pdf_bytes(
    ...
    doc    = SimpleDocTemplate(
        ...
        topMargin   = 15*mm,
        bottomMargin= 15*mm,
        title       = "CrawlIQ SEO Audit Report",
        author      = "CrawlIQ",
    )
    ...
    # ── Cover / header ──────────────────────────────────────────────────────
    story.append(_header_table(styles, site_url, crawl_status))
    ...
    story.append(Paragraph(
        "Generated by CrawlIQ — free AI SEO crawler · https://github.com/Bhavani5A8/seo-project",
        styles["small"],
    ))
...
def generate_pdf(
    ...
    data = generate_pdf_bytes(crawl_results, crawl_status, site_url)
